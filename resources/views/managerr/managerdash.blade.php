                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                <button class="btn btn-secondary btn-rounded" id="start-btn" onclick="startTimer()">Start Timer</button>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                <button class="btn btn-info btn-rounded">View Projects</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                <button class="btn btn-primary btn-rounded">View All</button>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                <button class="btn btn-success btn-rounded">View Shift</button>
                            </div>
                        </div>
                    </div>
                </div>
