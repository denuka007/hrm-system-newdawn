...
<div class="row">
    <div class="col-12">
        <div class="card align-items-center">
            ...
            <div class="card-body">
                <a href="#">
                    <button type="button" class="btn btn-info btn-lg">Add New HR Manager</button>
                </a>
                <a href="#">
                    ...
                    <tbody>
                        @foreach ($data as $emp)
                            <tr>
                                ...
                                <td>{{ $emp->worktype }}</td>
                                <td>
                                    <a href="" class="btn btn-success btn-rounded btn-sm">Edit</a>
                                    <a href="" class="btn btn-danger btn-rounded btn-sm">Delete</a>
